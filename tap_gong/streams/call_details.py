...
class CallDetailsStream(GongStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property("parties", th.ArrayType(th.ObjectType(
            th.Property("id", th.StringType),
        ))),
        th.Property("interaction", th.ObjectType(
            th.Property("speakers", th.ObjectType()),
        )),
        th.Property("collaboration", th.ObjectType()),
        th.Property("content", th.ObjectType(
            th.Property("trackers", th.ArrayType(th.ObjectType())),
            th.Property("topics", th.ArrayType(th.ObjectType())),
        )),
        th.ObjectType(
            th.Property("id", th.StringType),
            th.Property("metaData", th.ObjectType(
